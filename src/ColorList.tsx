...
const defaultColorList = [
  ...
  "linear-gradient(to top, rgb(250, 208, 196) 0%, rgb(250, 208, 196) 1%, rgb(255, 209, 255) 100%)",
  ...
  "linear-gradient(rgba(255, 255, 255, 0.15) 0%, rgba(0, 0, 0, 0.15) 100%), radial-gradient(at center top, rgba(255, 255, 255, 0.4) 0%, rgba(0, 0, 0, 0.4) 120%) rgb(152, 152, 152)",
  ...
  "linear-gradient(to top, rgb(101, 189, 96) 0%, rgb(90, 193, 168) 25%, rgb(62, 198, 237) 50%, rgb(183, 221, 183) 75%, rgb(254, 243, 129) 100%)",
        ...
        return (
          <div
            ...
            className={`color-list-item ${
              (props.activeIndex ?? 0) === index ? "active-color" : ""
            }`}
            onClick={() => {
              props?.changImageBgColor({
                color: item,
                index: index,
              });
            }}
...
ColorList.defaultColorList = defaultColorList;
